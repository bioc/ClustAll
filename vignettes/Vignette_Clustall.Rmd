...
df <- cluster2data(Object = obj_noNA1, 
                   clusterName = c("cuts_c_3","cuts_a_9","cuts_b_9"))
```
...
```{r}
df_NA <- cluster2data(Object = obj_NA1, clusterName = c("cuts_a_2"))
```
...
```{r, results=FALSE, warning=FALSE}
# The rest of the pipeline follows as a)
obj_imp1 <- runClustAll(obj_imp1, threads = 8) 
...
df_imp <- cluster2data(Object = obj_imp1, clusterName = c("cuts_a_4"))
