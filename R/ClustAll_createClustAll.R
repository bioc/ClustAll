...
setGeneric(
  name="createClustAll",
  def=function(data, nImputation=NULL, dataImputed=NULL){standardGeneric("createClustAll")}
)
...
setMethod(
  ...
  definition=function(data, nImputation=NULL, dataImputed=NULL) {
    ...
    clustAllObj <- new("ClustAllObject", data=data, dataImputed=dataImputed, nImputation=nImputation)
...
# END OF ClustAll_createClustAll.R
>>>>>>> 2fe83b316f24ea3a93386ca055b104ed0d38c023
